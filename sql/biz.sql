...
CREATE TABLE `biz_germplasm` (
  ...
  `longitude` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '经度',
  `latitude` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '纬度',
  `elevation` smallint unsigned DEFAULT NULL COMMENT '海拔(单位：米)',
  `life_form` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '生活型',
  `medicinal_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '药材名',
  `collection_address` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '采集地址',
  `collection_time` datetime DEFAULT NULL COMMENT '采集时间',
  `characteristics` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '种质特征',
  `preservation_location` varchar(20) NOT NULL DEFAULT '' COMMENT '种质保存位置',
  `plant_photograph` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '种质资源植物照片',
  `voucher_specimen` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '凭证标本',
  ...
  `del_flag` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否删除 0否1是',
  PRIMARY KEY (`id`)
